class PrintServices2 < Struct.new(:pyear, :pmonth, :pacco)
  ...
  def perform
    ...
    Prawn::Document.generate(Rails.root.to_s+"/public/fixedassets_pdf/各部門折舊表_#{year}_#{month}_#{acco}.pdf",:page_size=>"A4", :layout => :landscape) do #[1071,792]
      ...
      (0..document_data_array.count-1).each do |page|
        ...
        header(:a4, "東隆興業股份有限公司", "各部門折舊明細表", "折舊期間: #{year}/#{month}","","折舊方法:平均法",page+1)
