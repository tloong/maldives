...
def generate_data(data_hash,title_ary)
  ...
  # input1: query_date
  start_query_date = Date.new(2014,2,1)
  end_query_date = Date.new(2014,3,1)
  ...
  # start print pdf
  Prawn::Document.generate("pt6.pdf",:page_size=>[1071,792], :layout => :landscape) do
    page_num = 0
    page_string = ""
    ...
    (0..document_data_array.count-1).each do |page|
      ...
      header(:us_std_fanfold, "東隆興業股份有限公司", "固定資產出售統計表", "折舊期間: 103/06-103/06","","","#{page_num} / #{total_page}")
